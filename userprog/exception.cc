        ...
        case SyscallException:
            switch (type) {
                ...
                case SC_Open:
                    ...
                    {
                    char *filename = &(kernel->machine->mainMemory[val]);
                    OpenFileId fd = SysOpen(filename); // TODO: implement SysOpen
                    kernel->machine->WriteRegister(2, fd);  // write fd back to r2 register
                    }
                    kernel->machine->WriteRegister(PrevPCReg, kernel->machine->ReadRegister(PCReg));
                    kernel->machine->WriteRegister(PCReg, kernel->machine->ReadRegister(PCReg) + 4);
                    kernel->machine->WriteRegister(NextPCReg, kernel->machine->ReadRegister(PCReg) + 4);
                ...
                case SC_Read:
                    ...
                    int byteRead = SysRead(buffer, size, id);  // TODO: implement SysRead
                    kernel->machine->WriteRegister(2, byteRead);  // write byteRead back to r2 register
                    }
                    kernel->machine->WriteRegister(PrevPCReg, kernel->machine->ReadRegister(PCReg));
                    kernel->machine->WriteRegister(PCReg, kernel->machine->ReadRegister(PCReg) + 4);
                    kernel->machine->WriteRegister(NextPCReg, kernel->machine->ReadRegister(PCReg) + 4);
                ...
                case SC_Close:
                    ...
                    int result = SysClose(id);  // TODO: implement SysClose
